...
merge as soon as we can. If you do not return to your PR for edits within three months of our 
review, we will close the PR. 
...
Use the following JSX formatting to add an image to an article:
